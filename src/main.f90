program STB
   ...
   integer(int32)                         :: n_inp, n_files, start_idx, end_idx, cnt&
...
contains
   subroutine process_file(inp_file,sample_comm,n_sample,samples_per_comm,ColQ)
      ...
      real(dp)                        :: start, halt
      integer(int32)                        :: me, ierr,ierr2,me_sample
      logical                        :: perform_band, perform_dos, calc_hall, calc_hall_diag,&
   ...
   subroutine calc_ncomms(min_comm_size,nProcs,n_sample_par,ncomms)
      use mpi_f08
      implicit none
      integer(int32) , intent(in)           :: min_comm_size,nProcs,n_sample_par
      integer(int32)                        :: ncomms
   ...
   subroutine calc_color(min_comm_size,nProcs,n_sample_par,rank,color)
      use mpi_f08
      implicit none
      integer(int32) , intent(in)           :: nProcs,n_sample_par,rank,min_comm_size
      integer(int32)                        :: color,ncomms
      call calc_ncomms(min_comm_size,nProcs,n_sample_par,ncomms)
      color = 0
   ...
   function calc_samples_per_comm(n_sample_par,ncomms,color) result(samples_per_comm)
      use mpi_f08
      implicit none
      integer(int32) , intent(in)           :: n_sample_par,ncomms,color
      integer(int32)                        :: samples_per_comm, rest
